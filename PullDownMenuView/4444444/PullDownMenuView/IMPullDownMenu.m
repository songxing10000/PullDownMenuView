...
//    [self sizeWithFont:font constrainedToSize:size];
    [self boundingRectWithSize:size options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:font} context:nil].size;
    return textSize;
}
                         ...
                         menuFont:(UIFont *)aMenuFont
{
    ...
    {
        _menuHighLightColor = [UIColor blueColor];
    }
...
- (NSString *)trimStringByWidth:(CGFloat)width string:(NSString *)string
{
    ...
    while (YES)
    {
        ...
        CGSize size = [subStr XuSizeWithFont:[UIFont systemFontOfSize:fontSize] constrainedToSize:CGSizeMake(280, 0)];
...
- (CGSize)calculateTitleSizeWithString:(NSString *)string
{
    CGFloat fontSize = _menuFont.pointSize;// 14.0;
    NSDictionary *dic = @{NSFontAttributeName: [UIFont systemFontOfSize:fontSize]};
    CGSize size = size = [string XuSizeWithFont:[UIFont systemFontOfSize:fontSize] constrainedToSize:CGSizeMake(280, 0)];
